    ...
    return(
        <div className="home-container" ref={innerRef} id={id}>
            ...
            <TypeAnimation
                ...
                wrapper="span"
                speed={50}
                style={{ fontSize: '2em', display: 'inline-block', color:'var(--font-color)' }}
                repeat={Infinity}
            />
            <div className="button-group">
                <button className="resume-btn">resume</button>
                <button className="github-btn"><span className="icon-github"></span></button>
                <button className="linkedin-btn"><span className="icon-linkedin"></span></button>
            </div>
        </div>
    )
}
